                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Button(
                          ...
                          //         // }
                          //         if (exist == true) {
                          //           print("isLoginemail ${isLoginemail}");
                          //           if (isLoginemail == false) {
                          //             String pattern = r'(^(?:[+0]9)?[0-9]{1,12}$)';
                          //             RegExp regExp = RegExp(pattern);
                          //             print("match:- ${regExp.hasMatch(_email.text) }");
                          //             print("email length:- ${_email.text.length}");
                          //             print("dial max:- ${countries[phcode]['dial_max_length']}");
                          //             print("dial min:- ${countries[phcode]['dial_min_length']}");
                          ...
                          //               //   loginLoading = true;
                          //               // });
                          //               print("isCheckFireBaseOTP:- ${isCheckFireBaseOTP}");
                          //               if (isCheckFireBaseOTP) {
                          //                 var val = await otpCall();
                          //
                          //                 if (val.value == true) {
                          ...
                          //   }
                          //    else {
                          //      print("mobileVerified:- ${mobileVerified} otpSent::- ${otpSent}");
                          //     if (mobileVerified == true) {
                          //       dynamic val;
                          //       if (email != _email.text) {
                          //         val = await verifyUser(
