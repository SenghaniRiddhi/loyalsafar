...
//pick image from camera
                  ...
                  Column(
                    ...
                    children: [
                        ...
                        child: Row(
                          children: [
                            ...
                            VerticalDivider(
                              ...
                              width:
                              20, // Space occupied by the divider (including margin)
                              // indent: 20,         // Space from top
                              // endIndent: 20,      // Space from bottom
                            ),
                            Expanded(
                              child: SizedBox(
                                height: media.width * 0.12,
                      ...
                      if ((withOtp == false ||
                        ...
                        PinCodeTextField(
                          appContext: context,
                          length: 6, // Number of pin/OTP fields
                          obscureText:
                          false, // Use true for password-like behavior
                          ...
                          pinTheme: PinTheme(
                            ...
                            activeColor:
                            Color(0xffD9D9D9), // Active border color
                            inactiveColor:
                            Color(0xffD9D9D9), // Inactive border color
                            selectedColor:
                            iconColors, // Selected border color
                          ),
                          animationDuration: Duration(milliseconds: 300),
                          // backgroundColor: Colors.blue.shade50,
                          // enableActiveFill:
                          //     true, // Fills the active field background
                          controller:
                          _otp, // Controller for the pin input
                          onCompleted: (v) {
                            print("Completed: $v");
                          },
                          onChanged: (value) {
  ...
  Widget _buildOTPBox(
      int index, TextEditingController controllers, FocusNode focusNode) {
    return Container(
      width: 45,
      height: 55,
      ...
      decoration: BoxDecoration(
        border: Border.all(
          color: focusNode.hasFocus
              ? Colors.grey
              : Colors.red, // Gray when focused, Red otherwise
          width: 2,
        ),
        // border: Border.all(
        //     color: Colors.black
