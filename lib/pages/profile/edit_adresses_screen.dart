...
class EditAdressesScreen extends StatefulWidget {
  dynamic from;
  String? favName;
  EditAdressesScreen({super.key, this.from, this.favName});

  @override
  State<EditAdressesScreen> createState() => _EditAdressesScreenState();
}

class _EditAdressesScreenState extends State<EditAdressesScreen>
